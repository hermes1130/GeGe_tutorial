...
3. A venn diagram is also a good way to visualize overlap. Check out the `eulerr` package (Note, this package is not included for pre-installation before the tutorial, so work with your neighbor who has faster machine to install this package).
...
4. Interaction term for condition effect in Rank 2 vs. Rank 5 to find out whether the condition effect is different between these two ranks.
